      ...
      <div className="mx-auto w-full max-w-[720px] px-4 py-10 sm:px-6 sm:py-16">
        ...
        <form onSubmit={handleSubmit} noValidate className="mt-8 rounded-2xl border border-border bg-card p-5 shadow-brand sm:p-10">
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-2">
            ...
            <Button type="button" variant="outline" className="text-[20px] sm:text-[24px]" onClick={() => { setForm(initialForm); setErrors({}); setConsents(initialConsents); setExpanded(initialExpanded); setDateResetKey((k) => k + 1); }}>초기화</Button>
          </div>
        </form>
      </div>
    </main>
